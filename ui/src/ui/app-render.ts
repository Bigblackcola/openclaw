        ...
        <div class="topbar-left">
          ...
          <div class="brand">
            <div class="brand-logo">
              <img src=${basePath ? `${basePath}/favicon.svg` : "/favicon.svg"} alt="ByWolff" />
            </div>
            <div class="brand-text">
              <div class="brand-title">BYWOLFF</div>
              <div class="brand-sub">AI Assistant Platform</div>
            </div>
          </div>
        </div>
